    ...
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSwaggerGen(c =>
            {
                ...
                // header に Authorization を組み込むための設定
            ...
            {
                // User 間の Email の重複を許可しない
                opt.User.RequireUniqueEmail = true;
            }).AddRoles<Role>().AddEntityFrameworkStores<StoreContext>();
            // AddAuthentication は AddIdentityCore より下に記載する必要がある
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
            ...
            app.UseDefaultFiles(); // UseRouting() と UseCors() の間にある必要
            app.UseStaticFiles();
